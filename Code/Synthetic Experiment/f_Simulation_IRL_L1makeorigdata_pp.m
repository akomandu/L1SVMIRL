function [] = f_Simulation_IRL_L1makeorigdata_pp(S,A,m,nsamp,beta)
% A = 4;
% S = 4;
% nsamp = 500000;
n1 = 50;
...
% end
save(['Data_Files_L1/data_PPP_',num2str(S),'_',num2str(A),'_',num2str(m),'_',num2str(nsamp),'_samples.mat'],'S','A','m','nsamp','Pcell','PHatcell')
end
